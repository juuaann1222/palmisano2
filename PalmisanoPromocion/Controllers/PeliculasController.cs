...
namespace PalmisanoPromocion.Controllers
{
    public class PeliculasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,FechaEstreno,Foto,Trailer,Resumen,GeneroId")] Pelicula pelicula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,FechaEstreno,Foto,Trailer,Resumen,GeneroId")] Pelicula pelicula)
        {
            if (id != pelicula.Id)
            {
                return NotFound();
